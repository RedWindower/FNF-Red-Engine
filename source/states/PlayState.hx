...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['YOU FUCKING SUCK ASS AT THIS', 0.2], //From 0% to 19%
		['kaka', 0.4], //From 20% to 39%
		['Bro What?', 0.5], //From 40% to 49%
		['eugh', 0.6], //From 50% to 59%
		['i guess', 0.69], //From 60% to 68%
		['Sweet', 0.7], //69%
		['Cool', 0.8], //From 70% to 79%
		['All Right!', 0.9], //From 80% to 89%
		['YESSIR!', 1], //From 90% to 99%
		['HOLY SHIT YOUR AMAZING!!', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
